...
class RetentionManagerColdIntegrityTest {
    ...
    private class RecordingVersionStore : VersionStore {
        ...
        override fun putIsolated(
            versionId: VersionId,
            records: List<com.spike.ofac.pipeline.models.InternalModelEntry>,
        ) = throw UnsupportedOperationException()
        ...
        override fun atomicSetCurrent(
            sourceList: com.spike.ofac.pipeline.models.SourceList,
            versionId: VersionId,
        ): Boolean = throw UnsupportedOperationException()

        override fun getPointer(
            sourceList: com.spike.ofac.pipeline.models.SourceList,
            pointer: com.spike.ofac.pipeline.store.PointerKind,
        ): VersionId? = throw UnsupportedOperationException()

        override fun reclassifyCold(sourceList: com.spike.ofac.pipeline.models.SourceList) =
            throw UnsupportedOperationException()
        ...
        override fun lastIngested(
            sourceList: com.spike.ofac.pipeline.models.SourceList,
        ): com.spike.ofac.pipeline.models.VersionMetadata? = throw UnsupportedOperationException()

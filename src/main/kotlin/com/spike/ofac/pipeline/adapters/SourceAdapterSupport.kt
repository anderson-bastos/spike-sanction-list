 ...
 * [RawParsedProfile] into an [com.spike.ofac.pipeline.models.InternalModelEntry]
    ...
    fun entityTypeOf(rawProfile: RawParsedProfile): SourceEntityType =
        when (val classification = ScopeFilter.classify(rawProfile.partySubTypeId)) {
            is ScopeFilter.Classification.InScope -> when (classification.entityType) {
                com.spike.ofac.pipeline.models.EntityType.Individual -> SourceEntityType.Individual
                com.spike.ofac.pipeline.models.EntityType.Entity -> SourceEntityType.Entity
            }

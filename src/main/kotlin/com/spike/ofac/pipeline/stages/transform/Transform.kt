 ...
 * [com.spike.ofac.pipeline.stages.VersionStage]) it is **passed in by the
...
class Transform(
     ...
     *   [TransformResult.Ok.rawRecordCount] for [com.spike.ofac.pipeline.stages.VersionStage]
...
sealed interface TransformResult {
     ...
     *   straight to [com.spike.ofac.pipeline.stages.VersionStage] which validates

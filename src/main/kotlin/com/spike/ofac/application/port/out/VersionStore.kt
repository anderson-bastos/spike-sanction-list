...
interface VersionStore {
     ...
     * [COLD][com.spike.ofac.domain.model.VersionState.COLD] (Req 10.5, Req 14).
     */
    fun reclassifyCold(sourceList: SourceList)

    /**
     * Lists every version of [sourceList] currently classified
     * [COLD][com.spike.ofac.domain.model.VersionState.COLD] (Req 14).
     *
     ...
     * [integrityOk][com.spike.ofac.domain.model.VersionMetadata.integrityOk] to

...
import com.spike.ofac.adapter.out.source.JdkHttpTransport
...
class ObtainHttpIntegrationTest {
    ...
    private fun versionMetadata(digest: Sha256Digest) =
        com.spike.ofac.domain.model.VersionMetadata(
            ...
            expectedCount = 1,
            persistedCount = 1,
            state = com.spike.ofac.domain.model.VersionState.HOT,
